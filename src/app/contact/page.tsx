...
const contactCards = [
  ...
  },
  {
    ...
    action: "info@cliffstowing.ca",
    actionType: "email" as const,
  },
  {
    icon: MapPin,
    title: "Our Area",
    description: "Edmonton and surrounding region",
            ...
            <div className="grid lg:grid-cols-2 gap-6 sm:gap-12">
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 shadow-sm order-2 lg:order-1">
                ...
                <p className="text-gray-500 text-sm mb-6">
                  Fill out the form below and we&apos;ll get back to you as soon as possible — or call us for immediate assistance.
                </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Describe your situation, vehicle type, location..."
                      required
                    />
                  </div>
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-sm h-64 sm:h-80 lg:h-auto lg:min-h-[500px] order-1 lg:order-2">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d154528.46!2d-113.7!3d53.55!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x53a0224580deff23%3A0x411fa00c5b6a0f76!2sEdmonton%2C+AB!5e0!3m2!1sen!2sca!4v1680000000000!5m2!1sen!2sca"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="Cliff's Towing Service Area — Edmonton, AB"
                ...
                >
                  ...
                  {card.actionType === "email" && (
                    <a
                      ...
                      className="inline-block px-4 py-2 border border-primary text-primary rounded-lg text-xs font-medium hover:bg-red-50 transition-colors break-all"
                    >
                      {card.action}
                    </a>
                  )}
                  {card.actionType === "phone" && (
                    <a
                      ...
                      className="inline-block px-4 py-2 border border-primary text-primary rounded-lg text-xs font-medium hover:bg-red-50 transition-colors"
                    >
                      {card.action}
                    </a>
                  )}
